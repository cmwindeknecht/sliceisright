...
export default function OrderItemSimple({ orderItem }: OrderItemProps) {
  ...
  return (
    <div className="flex flex-col">
      <div className={clsx("flex flex-row items-stretch w-[30vw]")}>
